...
class Page(object):
    ...
    def __str__(self):
        return 'item count: %s, page count: %s, page index: %s, page size: %s, offset: %s, limit: %s' % (self.item_count, self.page_count, self.page_index, self.page_size, self.offset, self.limit)
